    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/connect')) {
            ...
            if (0 === strpos($pathinfo, '/connect/registration') && preg_match('#^/connect/registration/(?P<key>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hwi_oauth_connect_registration')), array (  '_controller' => 'AppBundle\\Controller\\ConnectController::registrationAction',));
            }
