...
class __TwigTemplate_3a8e6f47b0dfaa97932bcccd9850afcd5719c2bf02733c7b08e2be692692226b extends Twig_Template
{
    ...
    <div class=\"row\">
        <div class=\"span6\">
            <p>";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("connect.confirm.text", array("%service%" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans((isset($context["service"]) ? $context["service"] : null), array(), "HWIOAuthBundle"), "%name%" => $this->getAttribute((isset($context["userInformation"]) ? $context["userInformation"] : null), "realName", array())), "HWIOAuthBundle"), "html", null, true);
        echo "</p>
            <p>
                ";
        // line 9
        echo         $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->renderBlock((isset($context["form"]) ? $context["form"] : null), 'form_start', array("action" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("hwi_oauth_connect_service", array("service" => (isset($context["service"]) ? $context["service"] : null), "key" => (isset($context["key"]) ? $context["key"] : null))), "attr" => array("class" => "fos_user_registration_register")));
        echo "
                    ";
        // line 10
...
";
    ...
    {
        return new Twig_Source("", "HWIOAuthBundle:Connect:connect_confirm.html.twig", "C:\\Users\\Ayoub\\Desktop\\sym_proj\\test\\app/Resources/HWIOAuthBundle/views/Connect/connect_confirm.html.twig");
    }
}
